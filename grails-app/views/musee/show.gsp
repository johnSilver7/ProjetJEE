	...
	<body>
		...
		<div id="show-musee" class="content scaffold-show" role="main">
			...
			<ol class="property-list musee">
				...
				<g:if test="${museeInstance?.site}">
				<li class="fieldcontain">
					<span id="site-label" class="property-label"><g:message code="musee.site.label" default="Site" /></span>
					
						<span class="property-value" aria-labelledby="site-label"><g:fieldValue bean="${museeInstance}" field="site"/></span>
