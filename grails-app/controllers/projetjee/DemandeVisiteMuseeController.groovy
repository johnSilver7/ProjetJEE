...
class DemandeVisiteMuseeController {
    ...
    def faireDemande() {
        String erreur = demandeService.traiterDemande(params.nom,params.datedebut,params.datefin,params.nbpers)
        println erreur
        render(view: 'index', model: [demandeVisiteMuseeInstanceList: DemandeVisiteMusee.list(), demandeVisiteMuseeInstanceCount: DemandeVisiteMusee.count(), erreur : erreur])
    }
